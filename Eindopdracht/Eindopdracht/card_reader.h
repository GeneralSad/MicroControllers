...
#define BIT(x)		( 1<<x )
#define DDR_SPI		DDRC					// spi Data direction register
#define PORT_SPI	PORTC					// spi Output register
#define SPI_SS		3						// PB3: spi Pin Slave Select
#define SPI_SCK		4						// PB4: spi Pin System Clock
#define SPI_MOSI	5						// PB5: spi Pin MOSI
#define SPI_MISO	6						// PB6: spi Pin MISO
#define RESET		7						// PB7: Pin RST

#define ENABLE_CHIP() (PORT_SPI &= (~(1<<SPI_SS)))
#define DISABLE_CHIP() (PORT_SPI |= (1<<SPI_SS))
